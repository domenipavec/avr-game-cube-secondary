...
PRJSRC=main.cpp ./avr-cpp-lib/io.cpp
...
# Make targets:
# all, compile, disasm, stats, hex, writeflash/install, clean
all: $(TRG)
...
fuse:
	...
	-p $(PROGRAMMER_MCU) -B 1 -P $(AVRDUDE_PORT) \
	$(FUSE_SETTINGS)

writeflash: hex
	$(AVRDUDE) -c $(AVRDUDE_PROGRAMMERID)   \
	 -p $(PROGRAMMER_MCU) -B 1 -e -P $(AVRDUDE_PORT)       \
	 -U flash:w:$(HEXROMTRG)
